...
data_sampling:
  ...
  n_samples: 350000            # 350K correct samples (~175M 토큰)
  difficulty_bins:
    all: [1, 25]               # Critic과 동일 범위
  difficulty_weights:
    all: 1.0
...
data_sampling:
  ...
  use_length_balanced: true    # 길이 편향 제거
  n_samples: 250000            # 250K 쌍 (~250M 토큰)
  max_pairs_per_problem: 80    # 문제당 최대 쌍 수
  difficulty_bins:
...
training:
  n_epochs: 1.5
  batch_size: 24
  learning_rate: 2.0e-5        # LoRA backbone LR
```
